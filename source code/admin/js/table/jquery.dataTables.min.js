...
(function (i, za, p) {
        ...
        if (g.aanFeatures.p)
          for (var l = g.aanFeatures.p, s = 0, t = l.length; s < t; s++)
            if (l[s].childNodes.length !== 0) {
              l[s].childNodes[0].className =
                g._iDisplayStart === 0
                  ? g.oClasses.sPagePrevDisabled
                  : g.oClasses.sPagePrevEnabled;
              l[s].childNodes[1].className =
                g.fnDisplayEnd() == g.fnRecordsDisplay()
      ...
      fnUpdate: function (g, l) {
        if (g.aanFeatures.p) {
          ...
          for (s = t; s <= x; s++)
            F +=
              y != s
                ? '<span class="' + v.sPageButton + '">' + s + "</span>"
                : '<span class="' + v.sPageButtonActive + '">' + s + "</span>";
          x = g.aanFeatures.p;
          var z,
            $ = function (M) {
  ...
  i.fn.dataTable = function (g) {
    ...
    function s(a) {
      return function () {
        var b = [A(this[n.iApiIndex])].concat(
    ...
    function w(a, b) {
      ...
      if (typeof a.fnInitComplete == "function")
        typeof b != "undefined"
          ? a.fnInitComplete.call(a.oInstance, a, b)
          : a.fnInitComplete.call(a.oInstance, a);
    }
    function y(a, b, c) {
    ...
    function F(a, b) {
      ...
      a.aoColumns.push(b);
      if (
        typeof a.aoPreSearchCols[c] == "undefined" ||
    ...
    function z(a, b) {
      ...
      if (c.nTr === null) {
        ...
        for (var f = 0, e = a.aoColumns.length; f < e; f++) {
          ...
          d.innerHTML =
            typeof h.fnRender == "function" &&
            (!h.bUseRendered || h.mDataProp === null)
              ? h.fnRender({
                  iDataRow: b,
                  iDataColumn: f,
                  aData: c._aData,
    ...
    function C(a) {
      ...
      if (
        !(
          a.fnPreDrawCallback !== null &&
          a.fnPreDrawCallback.call(a.oInstance, a) === false
        )
      ) {
        a.bDrawing = true;
        if (
          typeof a.iInitDisplayStart != "undefined" &&
        ...
        if (a.aiDisplay.length !== 0) {
          ...
          e = a.oLanguage.sZeroRecords.replace(
            "_MAX_",
          ...
          if (
            ...
            typeof a.oLanguage.sEmptyTable != "undefined" &&
            a.fnRecordsTotal() === 0
          )
    ...
    function Aa(a) {
      ...
      a.sTableId !== "" &&
        a.nTableWrapper.setAttribute("id", a.sTableId + "_wrapper");
    ...
    function Ja(a) {
      ...
      var b = p.createElement("div"),
        ...
        u =
          a.nTable.getElementsByTagName("tfoot").length === 0
            ? null
            : a.nTable.getElementsByTagName("tfoot")[0],
        r =
          typeof g.bJQueryUI != "undefined" && g.bJQueryUI
            ? n.oJUIClasses
            : n.oStdClasses;
      c.appendChild(d);
      e.appendChild(h);
    ...
    function Ma(a) {
      ...
      if (i(a.nTable).outerWidth() < f) {
        j =
          d.scrollHeight > d.offsetHeight || i(d).css("overflow-y") == "scroll"
    ...
    function Ha(a) {
      ...
      b =
        b.indexOf("_INPUT_") !== -1
          ? b.replace("_INPUT_", '<input type="text" />')
          : b === ""
          ? '<input type="text" />'
          : b + ' <input type="text" />';
      ...
      a.sTableId !== "" &&
        typeof a.aanFeatures.f == "undefined" &&
    ...
    function Oa(a, b, c, d, f) {
      ...
      if (b.length <= 0) {
        ...
        a.oPreviousSearch.sSearch.length > b.length ||
        c == 1 ||
      ...
      for (b = 0; b < h; b++)
        a.aoColumns[b].bSortable &&
          i(a.aoColumns[b].nTh).removeClass(
            j.sSortAsc + " " + j.sSortDesc + " " + a.aoColumns[b].sSortingClass
          );
      f =
        a.aaSortingFixed !== null
          ? a.aaSortingFixed.concat(a.aaSorting)
            ...
            if (d[b].className.indexOf(e + "1") != -1) {
              ...
              for (a = d.length / h; c < a; c++)
                d[h * c + b].className = i.trim(
                  d[h * c + b].className.replace(e + "1", "")
                );
            } else if (d[b].className.indexOf(e + "2") != -1) {
              c = 0;
              for (a = d.length / h; c < a; c++)
                d[h * c + b].className = i.trim(
                  d[h * c + b].className.replace(e + "2", "")
                );
            } else if (d[b].className.indexOf(e + "3") != -1) {
              c = 0;
              for (a = d.length / h; c < a; c++)
                d[h * c + b].className = i.trim(
                  d[h * c + b].className.replace(" " + e + "3", "")
                );
            }
        j = 1;
        var k;
    ...
    function La(a) {
      ...
      typeof a.aanFeatures.p == "undefined" &&
    ...
    function ma(a, b) {
      ...
      if (b == "first") a._iDisplayStart = 0;
        ...
        a._iDisplayStart =
          a._iDisplayLength >= 0 ? a._iDisplayStart - a._iDisplayLength : 0;
    ...
    function Ra(a) {
      if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
        ...
        e =
          a.fnRecordsDisplay() === 0 &&
          a.fnRecordsDisplay() == a.fnRecordsTotal()
            ? a.oLanguage.sInfoEmpty + a.oLanguage.sInfoPostFix
            : a.fnRecordsDisplay() === 0
            ? a.oLanguage.sInfoEmpty +
              " " +
            ...
            ? a.oLanguage.sInfo
                .replace("_START_", e)
                .replace("_END_", h)
                .replace("_TOTAL_", k) + a.oLanguage.sInfoPostFix
            : a.oLanguage.sInfo
                .replace("_START_", e)
                .replace("_END_", h)
                .replace("_TOTAL_", k) +
              " " +
              a.oLanguage.sInfoFiltered.replace(
                "_MAX_",
                a.fnFormatNumber(a.fnRecordsTotal())
              ) +
              a.oLanguage.sInfoPostFix;
    ...
    function Ga(a) {
      ...
      var b =
          '<select size="1" ' +
          (a.sTableId === "" ? "" : 'name="' + a.sTableId + '_length"') +
          ">",
        c,
        d;
      if (
        a.aLengthMenu.length == 2 &&
      ...
      a.sTableId !== "" &&
        typeof a.aanFeatures.l == "undefined" &&
    ...
    function Ia(a) {
      var b = p.createElement("div");
      a.sTableId !== "" &&
        typeof a.aanFeatures.r == "undefined" &&
      ...
      if (
        ...
        if (a.oScroll.sX !== "") {
          for (e = d = c = 0; e < a.aoColumns.length; e++)
            if (a.aoColumns[e].bVisible) {
              c +=
                a.aoColumns[e].sWidthOrig === null
                  ? i(f[d]).outerWidth()
                  : parseInt(a.aoColumns[e].sWidth.replace("px", ""), 10) +
                    (i(f[d]).outerWidth() - i(f[d]).width());
              d++;
            }
          b.style.width = q(c);
    ...
    function va(a) {
      if (!(!a.oFeatures.bStateSave || typeof a.bDestroying != "undefined")) {
        ...
        f +=
          '"iEnd":' +
          (a.oScroll.bInfinite ? a._iDisplayLength : a._iDisplayEnd) +
          ",";
        f += '"iLength":' + a._iDisplayLength + ",";
        f +=
          '"sFilter":"' + encodeURIComponent(a.oPreviousSearch.sSearch) + '",';
    ...
    function Xa(a, b) {
      if (a.oFeatures.bStateSave) {
        ...
        if (d !== null && d !== "") {
          try {
            c =
              typeof i.parseJSON == "function"
                ? i.parseJSON(d.replace(/'/g, '"'))
                : eval("(" + d + ")");
          } catch (e) {
            return;
          }
    ...
    function Wa(a, b, c, d, f) {
      ...
      e = 9999999999999;
      if (
        (wa(a) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 >
        4096
      ) {
        a = p.cookie.split(";");
      ...
      for (var d = 0, f = b.length; d < f; d++)
        for (var e = 0, h = b[d].childNodes.length; e < h; e++)
          if (b[d].childNodes[e].nodeType == 1)
            typeof c != "undefined"
              ? a(b[d].childNodes[e], c[d].childNodes[e])
              : a(b[d].childNodes[e]);
    }
    function o(a, b, c, d) {
        ...
        if (b) {
          ...
          for (e = d.aoData.length; f < e; f++)
            if (d.aoData[f].nTr !== null)
              j
                ? d.aoData[f].nTr.appendChild(d.aoData[f]._anHidden[a])
    ...
    this.fnDestroy = function () {
      ...
      i("tbody>tr>td." + a.oClasses.sRowEmpty, a.nTable)
        .parent()
        .remove();
      ...
      if (a.bJUI) {
        i("th", a.nTHead).removeClass(
          [
            n.oStdClasses.sSortable,
            n.oJUIClasses.sSortableAsc,
            n.oJUIClasses.sSortableDesc,
            n.oJUIClasses.sSortableNone,
          ].join(" ")
        );
        ...
        i("th", a.nTHead).removeClass(
          [
            n.oStdClasses.sSortable,
            n.oStdClasses.sSortableAsc,
            n.oStdClasses.sSortableDesc,
            n.oStdClasses.sSortableNone,
          ].join(" ")
        );
      a.nTableReinsertBefore
        ? b.insertBefore(a.nTable, a.nTableReinsertBefore)
    ...
    return this.each(function () {
      ...
      for (b = D.length; a < b; a++) {
        if (D[a].nTable == this)
          if (
            typeof g == "undefined" ||
            (typeof g.bRetrieve != "undefined" && g.bRetrieve === true)
          )
      ...
      if (this.nodeName.toLowerCase() != "table")
        ...
        if (typeof g != "undefined" && g !== null) {
          ...
          typeof g.fnDrawCallback == "function" &&
            e.aoDrawCallback.push({ fn: g.fnDrawCallback, sName: "user" });
          typeof g.fnServerParams == "function" &&
            e.aoServerParams.push({ fn: g.fnServerParams, sName: "user" });
          ...
          typeof g.fnStateLoadCallback == "function" &&
            e.aoStateLoad.push({ fn: g.fnStateLoadCallback, sName: "user" });
          if (
            ...
            e.oFeatures.bDeferRender &&
              e.aoDrawCallback.push({ fn: V, sName: "defer_sort_classes" });
          ...
          if (
            typeof g.iDisplayStart != "undefined" &&
          ...
          if (typeof g.oLanguage != "undefined")
            if (
              typeof g.oLanguage.sUrl != "undefined" &&
              g.oLanguage.sUrl !== ""
            ) {
        ...
        if (
          typeof g.asStripClasses == "undefined" &&
        ...
        for (b = k.length; a < b; a++) {
          if (
            typeof g.saved_aoColumns != "undefined" &&
          ...
          for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
            ...
            i.isArray(m) ||
              J(
                e,
                1,
                "aTargets must be an array of targets, not a " + typeof m
              );
            c = 0;
