	...
	class cart
	{
		...
		public function add_to_cart($id, $quantity)
		{
			...
			$checkcart = "SELECT * FROM tbl_cart WHERE productId = '$id' AND sId = '$sId' ";			
 				$check_cart = $this->db->select2($checkcart);
		...
		public function update_product_soldout($proid,$qty){
			...
			$qtyall = $get_select["productQuantity"];
			$qty_total = $qty + $qtyold;
			$product_remain = $qtyall-$qty_total;
		...
		{
			$query = "SELECT * FROM tbl_customer WHERE customer_id = '$cusid' ";
