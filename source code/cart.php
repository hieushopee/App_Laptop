						...
						if ($get_info_cart){
							while ($result = $get_info_cart->fetch_assoc()) {
								...
								<tr>
									...
									<td><center><img src="admin/uploads/<?php echo $result['image'] ?>" alt="" /></center></td>
									<td><center>
...
<td><center><?php echo $fm->format_currency($result['price'])?>đ</center></td>
<td><center><?php echo $fm->format_currency($result['price']*$result['quantity'])?>đ</center></td>
<td><center><a href="?cartid=<?php echo $result['cartId']?>">Xóa</a></center></td>
</tr>
